...
const Cart = () => {
  ...
  const [country, setCountry] = useState("kompong cham");
  const [province, setProvince] = useState("Address ");
  const [zipcode, setZipcode] = useState("123");
  const [phone, setPhone] = useState("09988776544");
                  ...
                  <div className="content">
                    <div className="countries">
                      <div>
                        ...
                        >
                          <option defaultValue="Turkey">kpc</option>
